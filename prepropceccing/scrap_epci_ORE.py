...
# Параметры API
BASE_URL = "https://opendata.agenceore.fr/api/explore/v2.1/catalog/datasets/consommation-annuelle-d-electricite-et-gaz-par-epci/records"
LIMIT = 100
OFFSET = 0
all_records = []
...
df.to_csv("./DataAgenceORE/ORE_data_epci.csv", index=False)

print("✅ Готово! Данные сохранены в 'ORE_data_epci.csv'")
