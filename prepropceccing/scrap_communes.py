...
# Параметры API
BASE_URL = "https://data.enedis.fr/api/explore/v2.1/catalog/datasets/consommation-electrique-par-secteur-dactivite-commune/records"
LIMIT = 100
OFFSET = 0
all_records = []
...
df.to_csv("enedis_data_commune.csv", index=False)

print("✅ Готово! Данные сохранены в 'enedis_secteur_data.csv'")
