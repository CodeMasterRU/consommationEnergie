...
class DepartementBase(BaseModel):
    """Запись из enedis_departement_data (уровень департаментов)."""
    ...
    centroid: Optional[str] = None  # как в БД: строкой '{"lon":..,"lat":..}'

    # числовые парсеры
    @field_validator(
        "annee", "code_departement", "code_region",
...
class DepartementIn(DepartementBase):
    pass
